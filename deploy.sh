...
kubectl set image deployments/client-deployment client=lalkovic/multi-client:$SHA
kubectl set image deployments/worker-deployment worker=lalkovic/multi-worker:$SHA